<?php /* Smarty version Smarty-3.1.6, created on 2017-09-02 16:21:31
         compiled from "/phpstudy/www/myshop/Home/View/Index/index.html" */ ?>
<?php /*%%SmartyHeaderCode:187648292259aa6a0b0d9742-01192366%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c084f9e7adcdb112355bf9866ebc0b999b1ad06d' => 
    array (
      0 => '/phpstudy/www/myshop/Home/View/Index/index.html',
      1 => 1485440385,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '187648292259aa6a0b0d9742-01192366',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_59aa6a0b29380',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59aa6a0b29380')) {function content_59aa6a0b29380($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
...
style.css" rel="stylesheet" type="text/css" />
    ...
    <body class="index_body">
        <div class="block clearfix" style="position: relative; height: 98px;">
            <a href="#" name="top"><img class="logo" src="<?php echo @HOME_IMG;?>
logo.gif"></a>
        ...
        <div class="header_bg">
            ...
            <form id="searchForm" method="get" action="#">
                ...
                <input name="imageField" value=" " class="go" style="cursor: pointer; background: url('<?php echo @HOME_IMG;?>
...
biao6.gif" />
            ...
            <div class="f_r" style="padding-right: 10px;">
                <img style="vertical-align: middle;" src="<?php echo @HOME_IMG;?>
biao3.gif">
                    <span class="cart" id="ECS_CARTINFO">
                        <a href="#" title="查看购物车">您的购物车中有 0 件商品，总计金额 ￥0.00元。</a></span>
                    <a href="#"><img style="vertical-align: middle;" src="<?php echo @HOME_IMG;?>
biao7.gif"></a>
...
top_1.gif" class="iteration">
                                    <li class="topimg">
                                        <a href="#"><img src="<?php echo @HOME_IMG;?>
...
8_thumb_G_1241425513488.jpg" alt="飞利浦9@9v" class="goodsimg"></a><br />
        ...
        <div class="blank"></div>
        <div class="block">
            <a href="#" target="_blank" title="YONGDA商城"><img alt="YONGDA商城" src="<?php echo @HOME_IMG;?>
di.jpg"></a>
            <div class="blank"></div>
        </div>
        <div class="block">
        ...
        <div id="bottomNav" class="box block">
            <div class="box_1">
                <div class="links clearfix"> 
                    <a href="#" target="_blank" title="YONGDA商城"><img src="<?php echo @HOME_IMG;?>
